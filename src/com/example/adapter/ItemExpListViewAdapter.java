...
//		String queStr = getGroup(arg0).toString().replace("&nbsp;", "");
//		queTv.setDesc(queStr, BufferType.NORMAL, map, arg0);
//		queTv.setOnClickListener(descOpClickListener(queStr,queTv,arg0));
//		return view;
//	}
